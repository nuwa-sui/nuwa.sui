...
export type SuiMoveOptions<Entries extends Record<string, string> | string[] | string> = {
...
export default function myPlugin<Entries extends string | Record<string, string> | string[]>(options: SuiMoveOptions<Entries>): Plugin {
