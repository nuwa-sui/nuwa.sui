...
export class Context {
    ...
    public registerAttribute(attribute: MoveAttributeType): void {
    ...
    public registerResource(name: string, resource: MoveResourceType): void {
    ...
    public registerFunction(name: string, func: MoveFunctionType): void {
    ...
    public fork(environment: ContextEnvironment, name: string): Context {
        return new Context({
